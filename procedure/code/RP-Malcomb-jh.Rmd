...
# LHZ Data
lhz_scores_new = read.csv(here(private_r, "lhz_test.csv"))
lhz_scores_new$pctOwnCrop = "sof_crops" + "sof_livestock"
lhz_scores_new$pctIncWage = ,
lhz_scores_new$pctIncCashCrop =,
lhz_scores_new$disasterCoping = 
...
#do derivations in R // RDS this baby
```
...
ta_capacity_2010 <- hh_capacity_2010 %>%
