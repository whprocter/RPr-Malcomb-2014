...
```{r a table for adaptive capacity reporting all the individual variables used (after discarding records with missing data}
```
...
trial <- lhz_good %>% 
  select(LZCODE, LZNAMEEN, sof_crop, sof_livestock, soc_labour, soc_total, cp_tobacco, cp_sugar,	cp_tea,	cp_coffee, se_firewoord,	se_grass,	se_wildfood,	se_charcoal,	se_matmaking,	se_basket) 
