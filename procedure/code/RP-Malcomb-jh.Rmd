...
```{r reading all remaining data}
ta_gref = read_sf(here("data", "derived", "public", "ta_fig4_v.gpkg"), layer = "ta_fig4_v") %>% st_make_valid()
...
ta_capacity_v$vuln = aggregate(final,ta_capacity_v,mean)$capacity_2010 #THIS IS THE REAL Q, what's the mean doing
