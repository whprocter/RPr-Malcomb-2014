...
Additionally, since I managed to join TA name to the vulnerability by TA layer, I created a sorted data frame that shows lists the names of TAs in decending order of their vulnerability scores.  This allows policymakers and stakeholders to see the most vulnerable TAs and could be useful in terms of directing aid.
