...
p <- ggplot(data = mean_vulnerability) +
  geom_polygon(aes(fill = vulnerability)) +
  scale_fill_gradient(low = "lightblue", high = "darkred", name = "Average Vulnerability") +
  labs(title = "Average Vulnerability Scores by TA (State)") +
  theme_minimal()
...
# Customize the map and display it
p <- p +
...
#+
  #coord_map() +  # Ensures a suitable map projection
  #scale_fill_gradient(low = "lightblue", high = "darkred", name = "Average Vulnerability") +
  #labs(title = "Average Vulnerability Scores by State") +
  #theme_minimal()
